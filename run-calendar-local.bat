@echo off
title My Calendar local server
REM Put this .bat in your Calender_app folder (next to index.html)
...
if not exist "%ROOT%\index.html" (
  ...
  echo Put this .bat in the same folder as the calendar's index.html.
